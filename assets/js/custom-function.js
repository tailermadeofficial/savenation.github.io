...
$.getJSON('assets/js/states-districts.json', function(data){
...
$(document).ready(function () 
	...
	$("#state_travel").unbind('submit').bind('submit', function() {
			var form = $(this);
					...
					$.ajax({
					url : "https://tailermade.com/savemynation/api/v1/savemynation/Statetravel",
					type : "Post",
					data: new FormData(this),
                    contentType: false,  
                    processData:false,
...
$(document).ready(function () 
	...
	$("#city_travel").unbind('submit').bind('submit', function() {
			var form = $(this);
					...
					$.ajax({
					url : "https://tailermade.com/savemynation/api/v1/savemynation/Citytravel",
					type : "Post",
					data: new FormData(this),
                    contentType: false,  
                    processData:false,
...
$(document).ready(function () 
	...
	$("#support_us").unbind('submit').bind('submit', function() {
			var form = $(this);
					...
					$.ajax({
					url : "https://tailermade.com/savemynation/api/v1/savemynation/Supportus",
					type : "Post",
					data: new FormData(this),
                    contentType: false,  
                    processData:false,
